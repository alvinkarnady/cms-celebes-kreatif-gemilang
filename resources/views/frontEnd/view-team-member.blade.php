            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="team-detail-text">
                        ...
                        <ul>
                            @if ($member->facebook != '')
                                <li><a href="{{ $member->facebook }}" target="_blank"><i class="fab fa-facebook"></i></a>
                                </li>
                            @endif

                            @if ($member->twitter != '')
                                <li><a href="{{ $member->facebook }}" target="_blank"><i class="fab fa-twitter"></i></a>
                                </li>
                            @endif

                            @if ($member->linkedin != '')
                                <li><a href="{{ $member->linkedin }}" target="_blank"><i class="fab fa-linkedin"></i></a>
                                </li>
                            @endif

                            @if ($member->youtube != '')
                                <li><a href="{{ $member->youtube }}" target="_blank"><i class="fab fa-youtube"></i></a>
                                </li>
                            @endif

                            @if ($member->google_plus != '')
                                <li><a href="{{ $member->google_plus }}" target="_blank"><i
                                            class="fab fa-google-plus"></i></a></li>
                            @endif

                            @if ($member->instagram != '')
                                <li><a href="{{ $member->instagram }}" target="_blank"><i class="fab fa-instagram"></i></a>
                                </li>
                            @endif
