                ...
                @foreach ($team_members as $data)
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="team-item">
                            ...
                            <div class="team-text">
                                <a
                                    href="{{ route('home.team.member', ['id' => $data->id, 'slug' => $data->slug]) }}">{{ $data->name }}</a>
                            ...
                            <div class="team-social">
                                <ul>
                                    ...
                                    @if ($data->google_plus != '')
                                        <li><a href="{{ $data->google_plus }}" target="_blank"><i
                                    ...
                                    @if ($data->flickr != '')
                                        <li><a href="{{ $data->flickr }}" target="_blank"><i class="fab fa-flickr"></i></a>
                                        </li>
                                    @endif
