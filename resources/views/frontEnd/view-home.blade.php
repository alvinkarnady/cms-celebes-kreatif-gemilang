...
@section('content')
            ...
            @foreach ($sliders as $slider)
                <div class="slider-item flex" style="background-image:url({{ asset('upload/' . $slider->photo) }});">
                    ...
                    <div class="container">
                        <div class="row">
                            <div
                                class="@if ($slider->position == 'Left') {{ 'col-lg-6 col-md-9 col-12' }} @else {{ 'offset-lg-6 col-lg-6 offset-md-3 col-md-9 col-12' }} @endif">
                                        ...
                                        <div class="text-animated">
                                            <ul>
                                                @if ($slider->button1_text != '')
                                                    <li><a href="{{ $slider->button1_url }}">{{ $slider->button1_text }}</a>
                                                    </li>
                                                @endif

                                                @if ($slider->button2_text != '')
                                                    <li><a href="{{ $slider->button2_url }}">{{ $slider->button2_text }}</a>
                                                    </li>
                                                @endif
                                            </ul>
                                        </div>
        ...
        <div class="about-area pt_60 pb_90">
            <div class="container">
                <div class="row">
                            ...
                            <div class="progress-gallery main-prog">
                                ...
                                @if ($page_home->home_welcome_pbar1_text != '' && $page_home->home_welcome_pbar1_value != '')
                                    <div class="bar-container">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-success progress-bar-custom"
                                                role="progressbar"
                                                aria-valuenow="{{ $page_home->home_welcome_pbar1_value }}"
                                                aria-valuemin="0" aria-valuemax="100"
                                                style="width: {{ $page_home->home_welcome_pbar1_value }}%">
                                            </div>
                                        </div>
                                ...
                                @if ($page_home->home_welcome_pbar2_text != '' && $page_home->home_welcome_pbar2_value != '')
                                    <div class="bar-container">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-success progress-bar-custom"
                                                role="progressbar"
                                                aria-valuenow="{{ $page_home->home_welcome_pbar2_value }}"
                                                aria-valuemin="0" aria-valuemax="100"
                                                style="width: {{ $page_home->home_welcome_pbar2_value }}%">
                                            </div>
                                        </div>
                                ...
                                @if ($page_home->home_welcome_pbar3_text != '' && $page_home->home_welcome_pbar3_value != '')
                                    <div class="bar-container">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-success progress-bar-custom"
                                                role="progressbar"
                                                aria-valuenow="{{ $page_home->home_welcome_pbar3_value }}"
                                                aria-valuemin="0" aria-valuemax="100"
                                                style="width: {{ $page_home->home_welcome_pbar3_value }}%">
                                            </div>
                                        </div>
                                ...
                                @if ($page_home->home_welcome_pbar4_text != '' && $page_home->home_welcome_pbar4_value != '')
                                    <div class="bar-container">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-success progress-bar-custom"
                                                role="progressbar"
                                                aria-valuenow="{{ $page_home->home_welcome_pbar4_value }}"
                                                aria-valuemin="0" aria-valuemax="100"
                                                style="width: {{ $page_home->home_welcome_pbar4_value }}%">
                                            </div>
                                        </div>
                                ...
                                @if ($page_home->home_welcome_pbar5_text != '' && $page_home->home_welcome_pbar5_value != '')
                                    <div class="bar-container">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-success progress-bar-custom"
                                                role="progressbar"
                                                aria-valuenow="{{ $page_home->home_welcome_pbar5_value }}"
                                                aria-valuemin="0" aria-valuemax="100"
                                                style="width: {{ $page_home->home_welcome_pbar5_value }}%">
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-6 mt_30">
                        <div class="about-tab"
                            style="background-image: url({{ asset('upload/' . $page_home_lang_independent->home_welcome_video_bg) }})">
                            <div class="video-section">
                                <a class="video-button" href="#" data-toggle="modal"
                                    data-target="#myModal"><span></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    @foreach ($why_chooses as $data)
                        <div class="col-lg-4">
                            <div class="choose-item flex"
                                style="background-image: url({{ asset('upload/' . $data->photo) }})">
                            ...
                            <div class="services-item effect-item">
                                <a href="{{ route('service.view', $data->slug) }}" class="image-effect">
                                    <div class="services-photo"
                                        style="background-image: url({{ asset('upload/' . $data->photo) }})"></div>
                                </a>
                                <div class="services-text">
                                    ...
                                    <div class="button-bn">
                                        <a href="{{ route('service.view', $data->slug) }}">{{ READ_MORE }}<i
    ...
    @if ($page_home_lang_independent->counter_status == 'Show')
        <div class="counterup-area pt_60 pb_90"
            style="background-image: url({{ asset('upload/' . $page_home_lang_independent->counter_photo) }})">
            ...
            <div class="container">
                ...
                <div class="row filtr-container">
                    @foreach ($portfolios as $portfolio)
                        <div class="col-lg-4 col-md-6 filtr-item" data-category="{{ $portfolio->category_id }}"
                            data-sort="Menu">
                            <div class="portfolio-group">
                                <div class="portfolio-photo"
                                    style="background-image: url({{ asset('upload/' . $portfolio->photo) }})">
                                    <div class="portfolio-bg"></div>
                                    <div class="portfolio-table">
                                        <div class="portfolio-icon">
                                            <a href="{{ asset('upload/' . $portfolio->photo) }}" class="magnific"><i
                                ...
                                <div class="portfolio-text">
                                    <h3><a
                                            href="{{ route('portfolio.view', $portfolio->slug) }}">{{ $portfolio->name }}</a>
                                    </h3>
                                </div>
                            </div>
                        </div>
    ...
    @if ($page_home_lang_independent->home_booking_status == 'Show')
        <div class="booking-area pt_60 pb_90"
            style="background-image: url({{ asset('upload/' . $page_home_lang_independent->home_booking_photo) }})">
                                    ...
                                    <div class="form-row row">
                                        ...
                                        <div class="form-button col-12">
                                            <button type="submit" class="btn btn2"
                                                name="form_quick_contact">{{ SUBMIT }}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                            ...
                                            <div class="faq-header" id="heading{{ $i }}">
                                                <button class="faq-button collapsed" data-toggle="collapse"
                                                    ...
                                                    aria-controls="collapse{{ $i }}"><i
                                                        class="fa fa-caret-right"></i>{{ $faq->title }}</button>
                                            </div>
                        ...
                        <div class="offset-md-2 col-md-8 offset-md-2 offset-lg-0 col-lg-4">
                            <div class="price-item">
                                ...
                                <div class="price-footer">
                                    <div class="button-df">
                                        <a href="{{ $data->button_url }}">{{ $data->button_text }} <i
                                                class="fa fa-chevron-circle-right"></i></a>
                                    </div>
                                </div>
                            </div>
    ...
    @if ($page_home_lang_independent->home_testimonial_status == 'Show')
        <div class="testimonial-area pt_90 pb_90"
            style="background-image: url({{ asset('upload/' . $page_home_lang_independent->home_testimonial_photo) }})">
                        ...
                        <div class="blog-carousel owl-carousel">
                            ...
                            @foreach ($news_fetched as $data)
                                ...
                                <div class="blog-item effect-item">
                                    ...
                                    <div class="blog-text">
                                        <h3><a href="{{ route('news.view', $data->slug) }}">{{ $data->title }}</a>
                                        </h3>
                                    ...
                                    <div class="blog-author">
                                        ...
                                        <ul>
                                            ...
                                            <li class="blog-button"><a href="{{ route('news.view', $data->slug) }}"><i
                ...
                <div class="col-12">
                    <div class="brand-carousel owl-carousel">
                        @foreach ($clients as $data)
                            @if ($data->url != '')
                                <div class="brand-item"><a href="{{ $data->url }}"><img
                                            src="{{ asset('upload/' . $data->photo) }}" alt="{{ $data->name }}"></a>
                                </div>
                            @else
                                <div class="brand-item"><img src="{{ asset('upload/' . $data->photo) }}"
                                        alt="{{ $data->name }}"></div>
                            @endif
                        @endforeach
                    </div>
