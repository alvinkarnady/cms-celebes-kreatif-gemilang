...
class SettingController extends Controller
{
    ...
    public function textItemsUpdate(Request $request, $id)
    {
        ...
        // TAMBAHAN
        if ($request->front_end_color_body != null) {
            $setting->update([
                'front_end_color_body' => $request->front_end_color_body,
            ]);
        }
        if ($request->front_end_color_bg_section != null) {
            $setting->update([
                'front_end_color_bg_section' => $request->front_end_color_bg_section,
            ]);
        }
        if ($request->front_end_color_bg_footer != null) {
            $setting->update([
                'front_end_color_bg_footer' => $request->front_end_color_bg_footer,
            ]);
        }
